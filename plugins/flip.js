...
gay = `sayang`
  ...
  let buffer = await (await fetch('http://api.lolhuman.xyz/api/editor/flip?apikey=31caf10e4a64e86c1a92bcba&img=' + img + '&apa=nani')).buffer() // Masukan ApiKeymu disini..
...
handler.help = ['flip (reply)']
handler.tags = ['editor']
handler.command = /^flip$/i
handler.owner = false
handler.mods = false
