...
gay = `sayang`
  ...
  let buffer = await (await fetch('http://api.lolhuman.xyz/api/editor/rotate?apikey=31caf10e4a64e86c1a92bcba&img=' + img + '&rotate=180')).buffer() // Masukan ApiKeymu disini..
...
handler.help = ['flip2 (reply)']
handler.tags = ['editor']
handler.command = /^flip2$/i
handler.owner = false
handler.mods = false
